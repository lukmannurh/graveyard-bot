...
export const kingIndo = async (message, args) => {
  try {
    ...
    if (args[0] === "1") {
      ...
      await message.reply(
        "Pilihan tidak valid. Gunakan 1 untuk jadwal atau 2 untuk hasil pertandingan."
      );
      return;
    }
    ...
    await message.reply(
      "Terjadi kesalahan saat mengambil data pertandingan. Silakan coba lagi nanti."
    );
  }
};
